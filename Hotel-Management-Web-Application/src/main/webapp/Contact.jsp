...
<html>
    <head>
        ...
        <title>LionTech Resort Rooms</title>
        <!--        <meta charset="UTF-8" />-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    ...
                    <p>
                        <strong>Hotel</strong> +1647 381 8836<br />
                        <strong>Fax:</strong>++1647 381 8836</p>
                    <div class="dropdown-divider"></div>
                    <h6 class="p-2 border-danger rounded d-inline-block" style="background: gray; margin-down=10px;">EMAIL</h6>
                    <p>
                        <a href="mailto:info@Liontechacademy.com" style="color:black">info@Liontechacademy.com</a><br>
                        <a href="mailto:operations@liontechacademy.com" style="color:black"> operations@liontechacademy.com</a>
                    </p>
                    <div class="dropdown-divider"></div>
                </div>
